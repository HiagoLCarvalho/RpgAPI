...
VALUES (1, 1, 23, 17, 33, N'HiagoCarvalho', 100),
(2, 1, 25, 15, 30, N'Alana', 100),
(3, 3, 21, 18, 35, N'Daniel', 100),
(4, 2, 18, 18, 37, N'Yan', 100),
(5, 1, 17, 20, 31, N'Gabriel', 100),
(6, 3, 13, 21, 34, N'Gabrielly', 100),
(7, 2, 11, 25, 35, N'Isabella', 100);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Classe', N'Defesa', N'Forca', N'Inteligencia', N'Nome', N'PontosVida') AND [object_id] = OBJECT_ID(N'[Personagens]'))
...
UPDATE [Usuarios] SET [PasswordHash] = 0x29DA9C38AA7793EC4C63D2582CED8E954881F0C8CF99EA93B7DC02F9040457DCAE333AF791D8275CF8546C10B8EB565E11A0AED4AB015D84716EF33DA573323F, [PasswordSalt] = 
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220519042209_MigracaoDisputas', N'5.0.15');
GO
